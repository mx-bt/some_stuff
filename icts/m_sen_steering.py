...
try:
    ep_robot.initialize(conn_type="sta", sn=list_robot_serial_numbers[1]) # config sn
...
if __name__ == "__main__":
    ...
    #                 print("X: ", round(axis_x,3), "  Y: ", round(axis_y,3), "  Z: ", round(axis_z,3))
